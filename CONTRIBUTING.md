...
## 7. Contributing to NexusPulse repositories

This file is the default contributing guide for every NexusPulse repository that does not have its own.
To suggest a change, open an issue or a pull request against `main` in the repository you want to change.
